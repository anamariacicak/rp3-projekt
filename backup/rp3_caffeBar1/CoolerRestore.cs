...
{
    public partial class CoolerRestore : Form
    {
        public CoolerRestore()
        {
            InitializeComponent();
        ...
        private void button_dodaj_Click(object sender, EventArgs e)
        {
            if(textBox_proizvod.Text!="" && textBox_hladnjak.Text != "" && textBox_skladiste.Text != "" && textBox_dodati.Text!=""
                && int.Parse(textBox_dodati.Text.ToString()) <= int.Parse(textBox_skladiste.Text.ToString()))  //ako nesto pise i ispravno je
            {
